...
<html>
    <head>
        <title>RP Consent List</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <script src="//code.jquery.com/jquery-2.1.4.min.js"></script>
        <link rel="icon" type="image/x-icon" href="data:image/x-icon;base64,">
        <style>
            body {
    ...
    <body>
        <div class="widthWrapper">
            ...
            <h1>RP Consent List</h1>
            <div class="legend">
                <div><span data-color="#FFFFFF" class="choice notEntered"></span> <span class="legend-text">Not Entered</span></div>
                <div><span data-color="#add8e6" class="choice favorite"></span> <span class="legend-text">Favorite</span></div>
...
#Overarching Consent
(General)
* Permanent injury to your character
* Romancing your character
...
(Offering, Receiving)
* Amnesia/Memory Loss
* Animalistic Behavior/Going "Feral"
...
* Mind control
* Possession/Voidsent
* Psychosis or Psychotic Breakdowns
* Stalking
* Suicide
* Self Harm
...
(Offering, Receiving)
* Acid
* Being Eaten Alive (Vore)
* Blood
* Body Horror (Minor to Moderate)
* Body Horror (Moderate to Severe)
* Bodily Fluids (Excluding Blood)
* Burning/Death by Fire
* Cannibalism
* Deep Water
* Disease/Health
* Dismemberment
* Drowning
* Doppelgangers/Being replaced with a copy
* Electrocution
* Eyeballs/Eye Trauma
* Freezing to death
* Gore/Guts
* Hand/Fingernail Trauma
* Human/Ritual Sacrifice
* Medical Experimentation
* Neck and Throat Trauma
* Non-Consensual Body Modification
* Paralysis
* Physical Abuse
* Scarring
* Sensory Loss (Sight, Hearing, Touch, Taste, Smell)
* Sexual Abuse (Men)
* Sexual Abuse (Women)
* Sexual Abuse (Other)
* Starvation
...
(Offering, Receiving)
* Bugs and Insects (General)
* Dolls/Puppets
* Ghosts/Spirits
* Harm to Animals
* Magic (General)
* Magic (Curses)
* Necromancy/The Undead/Zombies
* Needles / Pointed Objects
* Poison/Venom (Short Term)
* Poison/Venom (Long Term)
* Rats
* Snakes
* Spiders
...
#Disease & Health
(Offering, Receiving)
* Alcohol Abuse/Addiction Issues                
* Autoimmune diseases (General)/Chronic Disease
* Cancer or similar diseases
* Necrosis/Rotting Flesh
* Parasites
* Pregnancy
* Substance Abuse/Addiction Issues (excluding Alcohol)

#Sociopolitical Issues
(General)
* Genocide
* Human Trafficking
* Plague/Pandemic/Global disease epidemic
* Prostitution
* Public Execution
* Racism (Fantasy)
* Rape/Sexual Assault
